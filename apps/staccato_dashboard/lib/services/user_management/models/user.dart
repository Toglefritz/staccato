...
///
/// The [StaccatoUser] model is immutable and contains all necessary information for authentication, authorization, and profile
/// management.
class StaccatoUser {
  /// Creates a new [StaccatoUser] instance with the specified properties.
  ///
  ...
  /// Creates a StaccatoUser instance from a JSON map.
  ///
  ...
  ///
  /// Returns a new [StaccatoUser] instance with data from the JSON map.
  ///
  ...
  factory StaccatoUser.fromJson(Map<String, dynamic> json) {
    try {
      ...
      throw FormatException('Failed to parse StaccatoUser from JSON: $e');
    }
  }

  /// Converts this StaccatoUser instance to a JSON map.
  ///
  ...
  /// Creates a copy of this StaccatoUser with the specified fields updated.
  ///
  /// This method returns a new StaccatoUser instance with the same values as the current instance, except for the fields
